'use client'
import styles from "./TariffApplication.module.scss";
...
interface TariffApplicationProps {
    onClose: () => void;
}

export const TariffApplication: React.FC<TariffApplicationProps> = ({ onClose }) => {
