  ...
  return (
    <div className={styles.tradeOperation}>
      <div className={styles.tradeOperation_title}>
        <h2 className={styles.tradeOperation_title_header}>
          Желаете продать или купить оптом?
        </h2>
          ...
          <div className={styles.tradeOperation_childBlock}>
            <div className={styles.tradeOperation_form}>
              <div className={styles.tradeOperation_childForm}>
                <h4 className={styles.tradeOperation_headerForm}>
                  Продать оптом
                </h4>
                <div className={styles.tradeOperation_inputBlock}>
                  <div className={styles.tradeOperation_inputText}>
                    <p className={styles.tradeOperation_text}>
                      Что хотите продать?
                    </p>
                    <input
                      className={styles.tradeOperation_input}
                ...
                <div className={styles.tradeOperation_spanBtn}>
                  <span className={styles.tradeOperation_span}>
                    Lorem ipsum dolor sit amet consectetur. Orci dolor a
                    consectetur arcu aenean cursus sed netus.
                  </span>
                  <button className={styles.tradeOperation_btn}>
                    Найти клиентов
                  </button>
                </div>
              </div>
